...
public class DistriCacheTest {

	public static final String URLS_FILE = "/urls/same_urls.txt";
	...
	public static void main(String[] args) {
		try {
			...
			DistriTask firstTask = new DistriTask(urls.get(0), 1);
			control.addTask(firstTask);
			Thread.sleep(3000);
